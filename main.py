...
if __name__ == '__main__': # This removes the following error: "RuntimeError: An attempt has been made to start a new process before the current process has finished its bootstrapping phase"
